...
function createDayBarChart(){
    ...
    var dow = [
        {day: "Doming", data: undefined},
        {day: "Segunda", data: undefined},
        {day: "Terça", data: undefined},
        {day: "Quarta", data: undefined},
        {day: "Quinta", data: undefined},
        {day: "Sexta", data: undefined},
        {day: "Sábado", data: undefined}
    ];
...
function createMonthBarChart(){
    ...
    var mon = [
        {month: "Janeiro", data: undefined},
        {month: "Fevereiro", data: undefined},
        {month: "Março", data: undefined},
        {month: "Abril", data: undefined},
        {month: "Maio", data: undefined},
        {month: "Junho", data: undefined},
        {month: "Julho", data: undefined},
        {month: "Agosto", data: undefined},
        {month: "Setembro", data: undefined},
        {month: "Outubro", data: undefined},
        {month: "Novembro", data: undefined},
        {month: "Dezembro", data: undefined}
    ];
...
function updateChart() {
    ...
    // if(d3.select())
    d3.selectAll(".div-legend p").remove();

    var div = d3.select(".div-legend");

    var p = div.selectAll('p').data(arrayOfLines).enter().append('p').attr("width", 20)
    p.append("input")
        .attr("type", "checkbox")
        .attr("checked", "checked")
        .attr("class", "filled-in")
    ...
    var label = p.append("label")
        .attr("for", function(d,i){return d.key})
    ...
    label.append("svg").attr("width",20).attr("height", 20).style("margin-bottom", 20)
        ...
        .attr("cx", 10)
        .attr("cy", 10)
        .attr("fill", function(d){return carriers(d.key)})
    label.append("text")
        .attr("class", "legend-text")
